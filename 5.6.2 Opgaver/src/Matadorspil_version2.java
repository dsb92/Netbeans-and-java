//Opgave 1 og 2;
// Har sparet halv så meget ved at benytte Grund2 klassen som egentlig er fælles for Gade2, Rederi2, og dermed også bryggeri. 
import java.util.*;
...
public class Matadorspil_version2
{
	...
	public Matadorspil_version2() 
	{
		...
		felter.add(new Gade2("Gade 5", 15000, 700,1500));
                felter.add(new Bryggeri("Tuborg", 16000, 500));
