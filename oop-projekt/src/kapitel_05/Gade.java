package kapitel_05;
/** En gade, der kan kÃ¸bes af en spiller og bebygges */
public class Gade extends Felt
{
	...
	public void landet(Spiller sp)
	{
		...
		{	                                        // eget felt
			...
			if (antalHuse<5 && sp.konto>huspris &&  // bemÃ¦rk: kun hvis betingelserne
			  sp.spørgsmål("købe hus for "+huspris))// er opfyldt stilles spÃ¸rgsmÃ¥let
			{                                       // byg et hus
