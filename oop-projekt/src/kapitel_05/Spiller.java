...
{
	String navn;       // spillerens navn, f.eks. "SÃ¸ren"
	double konto;      // antal kroner pÃ¥ spillerens konto
	int feltnr;        // hvad nummer felt spilleren stÃ¥r pÃ¥. â€?Startâ€? er nummer 0
	...
	/** Et ja/nej-spÃ¸rgsmÃ¥l. Svarer brugeren ja returneres true, ellers false */
