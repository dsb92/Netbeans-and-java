...
public class OverblikOverKomponenter extends JPanel
{
	...
	String[] listedata = {"List r√∏d", "List gr√∏n", "List bl√•"};
	...
	private void jbInit() throws Exception {
		...
		checkbox1.setText("En");    // sÊt afkrydsningsfelternes navne
		checkbox2.setText("To");
		checkbox3.setText("Tre");

		radio1.setText("Radio1");   // sÊt radioknappernes navne og
		radio2.setText("Radio2");
		buttonGroup1.add(radio1);   // gruppe - sÂ de gensidigt udelukker hinanden
		buttonGroup1.add(radio2);
		radio1.setSelected(true);

		comboBox1.addItem("ComboBox R√∏d");
		comboBox1.addItem("ComboBox Gr√∏n");
		comboBox1.addItem("ComboBox Bl√•");
		...
		this.setLayout(flowLayout1);// sÊt layout-manager (se senere)

		this.add(label1);     // til sidst skal komponenterne f√∏jes
